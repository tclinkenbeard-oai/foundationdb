...
public:
	...
	std::vector<std::unique_ptr<IFactor>>& getFactors() { return factors; }
	Reference<IWorkerEventProvider const> getWorkerEventProvider() const { return workerEventProvider; }
	Future<Void> run();
};
